// js-yaml library for saving and loading of database whenever the server boots
...
//<---Begin defining route logic for comments--->
  '/comments': {
    'POST': createComment
  },
  '/comments/:id': {
...
//<---End defining route logic for comments--->
};

//<--Begin defining logic for persistence of database-->
...
//<--End definition of logic for persistence of database-->

//<---Begin defining database logic for comments--->
...
//<---End defining database logic for comments--->
